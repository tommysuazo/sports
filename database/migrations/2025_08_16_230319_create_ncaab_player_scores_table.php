...
return new class extends Migration
{
    ...
    {
        Schema::create('ncaab_player_scores', function (Blueprint $table) {
            $table->id();
            $table->foreignId('game_id')->constrained('ncaab_games');
            $table->foreignId('team_id')->constrained('ncaab_teams');
            $table->foreignId('player_id')->constrained('ncaab_players');
    ...
    {
        Schema::dropIfExists('ncaab_player_scores');
    }
};
